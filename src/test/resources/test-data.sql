...
insert into users (id, first_name, last_name, email, password) values (1, 'John', 'Doe', 'john.doe@test.com', '$2a$10$tW8vhiUfsb4Hf4jVXJUCDOfukxuHojeNgmQTdkmrtye65RvGDVmj2')